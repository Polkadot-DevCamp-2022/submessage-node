		...
		move || {
			testnet_genesis(
				...
				vec![
					...
					// REF: https://stackoverflow.com/questions/56392875/how-can-i-initialize-a-users-balance-in-a-substrate-blockchain
					AccountId::from_ss58check("5CrB412RE6E2XyLCN7Mh78HBxVbcSJhfhDReemC4mJqLG19s").unwrap(),
					AccountId::from_ss58check("5Dk7bJyN8MpPGu2hHt23tfFpagskRrzyrYEwpoPAvQPNkU38").unwrap(),
				],
				true,
			)
		},
